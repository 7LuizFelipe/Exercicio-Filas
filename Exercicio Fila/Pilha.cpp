...
TipoCelulaP *Topo; //Vari�vel utilizada para manter o controle do estado atual da pilha
                  //Como a pilha � implementada em mem�ria din�mica,
                  //Topo deve ser um ponteiro para a c�lula no topo da Pilha

int ContadorP;  //Vari�vel para contar o n�mero de elementos armazenados na Pilha
...
void Pilha_Construtor()
{
  ...
  ContadorP = 0;  //Inicia a vari�vel para indicar a quantidade de elementos armazenados na Pilha
}
...
void Pilha_Destrutor()
{
   ...
   TipoCelulaP *Temp;  //Ponteiro tempor�rio utilizado para desalocar a mem�ria
...
bool Pilha_Vazia()
{
   return Topo == NULL;   //Pela forma como os elementos s�o Empilhados e Desempilhados (m�todos a seguir)
                          ...
                          //Esse comando poderia tamb�m ser substitu�do por ContadorP == 0
...
int Pilha_Tamanho()
{
    ...
    return ContadorP;   //� retornado o ContadorP de elementos, manipulado nos m�todos de Empilhar e Desempilhar
}
...
bool Pilha_Empilhar(TipoDadoP Elemento)
{
   ...
   TipoCelulaP *Nova;  //Ponteiro tempor�rio utilizado para apontar para a nova c�lula a ser criada
...
bool Pilha_Desempilhar(TipoDadoP &Elemento)
{
   ...
   if(!Pilha_Vazia())  //primeiro deve-se conferir se a Pilha n�o est� vazia
   {
      ...
      TipoCelulaP *Temp = Topo;  //Cria um ponteiro tempor�rio (Temp) e faz apontar para o mesmo endere�o de Topo
